...
function print_ad() {
    ...
    <form name="printform" action="'.$path.'print.php" method="post" target="printme" onsubmit="formpopup();">
	...
	<input type="hidden" name="site_url" value="'.osc_base_url().'">
        ...
        <a id="print_ad" href="#" onClick="formpopup();document.printform.submit();return false;"><i class="fa fa-print"></i> ' . __('Print item', 'print_ad') . '</a>
    </form>
