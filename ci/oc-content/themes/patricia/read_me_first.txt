------- How to install? ------
1. Upload theme (file: patricia.zip) via admin site or upload it into your webhost directly to themes folder
2. Download plugins on http://mb-themes.com/theme-plugins/patricia-plugins.zip
3. Upload & extract patricia-plugins.zip located into plugins folder: oc-content/plugins/
